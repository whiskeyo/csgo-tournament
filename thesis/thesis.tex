...
\begin{figure}[H]
	\centering
	$\vcenter{\hbox{\includegraphics[width=0.65\textwidth]{images/vue-sfc-example.png}}}$
...
\begin{figure}[H]
	\centering
	$\vcenter{\hbox{\includegraphics[width=0.6\textwidth]{images/vue-cycle-injection.png}}}$
...
\begin{figure}[H]
	\centering
	$\vcenter{\hbox{\includegraphics[width=0.6\textwidth]{images/conceptual-model.png}}}$
...
\begin{figure}[H]
	\centering
	$\vcenter{\hbox{\includegraphics[width=\textwidth]{images/c4-layer-two.png}}}$
...
\begin{figure}[H]
	\centering
	$\vcenter{\hbox{\includegraphics[width=\textwidth]{images/c4-layer-three.png}}}$
